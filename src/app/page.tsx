    ...
    <div style={{ background: "var(--bg)", color: "var(--text)", minHeight: "100vh" }}>
      ...
      <section style={{
        ...
        <h1 style={{
          ...
          TRAIN SMARTER.{" "}
          <span style={{ background: "linear-gradient(90deg, #ff4d00, #ff8c00)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            PERFORM BETTER.
          </span>
        </h1>
      ...
      <section style={{ padding: "100px 24px", textAlign: "center", borderTop: "1px solid var(--border)" }}>
        <h2 style={{ fontSize: "clamp(36px, 6vw, 72px)", fontWeight: 900, letterSpacing: "-3px", marginBottom: "24px", lineHeight: 0.95 }}>
          READY TO{" "}
          <span style={{ background: "linear-gradient(90deg, #ff4d00, #ff8c00)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>RIZE?</span>
        </h2>
